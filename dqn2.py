...
def learn(env,
    ...
    q_val_obs_t = q_func(obs_t_float, num_actions, session, scope="q_func", reuse=False)
    q_val_obs_tp1 = q_func(obs_tp1_float, num_actions, session, scope="target_q_func", reuse=False)
    ...
    train_fn = minimize_and_clip(optimizer, total_error,
                 var_list=q_func_vars_train, clip_val=grad_norm_clipping)
    ...
    for t in itertools.count():
        ...
        if t % LOG_EVERY_N_STEPS == 0 and model_initialized:
            ...
            if logging_iter == 0: 
                ...
                with open(filename_hyper, 'w+') as f:
                ...
                with open(filename_log, 'w+') as f:
                    f.write("time, mean reward 100 episode, best mean reward, episodes, exploration, learning rate\n")
                    logging_iter += 1
